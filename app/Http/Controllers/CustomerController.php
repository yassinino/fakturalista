...
class CustomerController extends Controller
{
    ...
    public function store(CustomerRequest $request)
    {
        ...
        $new_customer = Customer::create([
            ...
            'foreign_tax_id_type' => $request->foreign_tax_id_type,
            'foreign_tax_id' => $request->foreign_tax_id,
    ...
    public function show(Customer $customer)
    {
        ...
        $customer = [
            ...
            'ice' => $customer->ice,
            'if_number' => $customer->if_number,
            'commercial_register' => $customer->commercial_register,
            'tax_id' => $customer->tax_id,
            'foreign_tax_id_type' => $customer->foreign_tax_id_type,
            'foreign_tax_id' => $customer->foreign_tax_id,
            'type' => $customer->type,
