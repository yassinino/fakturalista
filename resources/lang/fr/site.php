...
return [
    ...
    'contact' => [
        'page_title'          => 'Contact',
        'meta_desc'           => 'Une question sur Fakturalista, votre abonnement ou votre facturation ? Écrivez-nous, notre équipe vous répond directement.',
        'header_tag'          => 'Contact',
        'header_title'        => 'Parlez-nous de votre besoin. On vous répond personnellement.',
        'header_title_html'   => 'Parlez-nous de votre besoin.<br><span class="fk-highlight">On vous répond personnellement.</span>',
        'header_sub'          => 'Une question sur Fakturalista, votre abonnement ou votre facturation ? Écrivez-nous. Notre équipe vous répond directement.',

        'form_title'          => 'Envoyez-nous un message',
        'form_sub'            => 'Expliquez-nous simplement votre demande et nous vous répondrons dès que possible.',
        ...
        'label_company'       => 'Entreprise (facultatif)',
        'placeholder_company' => "Nom de votre entreprise",
        'label_subject'       => 'Sujet *',
        'placeholder_subject' => 'Choisissez un sujet',
        'subject_general'     => 'Question sur Fakturalista',
        'subject_pricing'     => 'Abonnement et tarifs',
        'subject_support'     => 'Aide technique',
        'subject_billing'     => 'Facturation',
        'subject_partnership' => 'Partenariat',
        'subject_other'       => 'Autre',
        'label_message'       => 'Message *',
        'placeholder_message' => 'Expliquez-nous comment nous pouvons vous aider…',
        'btn_submit'          => 'Envoyer mon message',

        'info_title'          => 'Contactez-nous directement',
        'info_sub'            => 'Vous préférez nous contacter directement ? Nous sommes disponibles pour répondre à vos questions.',
        'label_email'         => 'E-mail',
        'label_phone_card'    => 'Téléphone',
        'label_location'      => 'Localisation',
        'location_value'      => 'Maroc',

        'trust_title'         => 'Une équipe accessible',
        'trust_text'          => 'Fakturalista est développé avec une idée simple : rendre la facturation plus facile pour les professionnels. Une question ? Vous pouvez nous contacter directement.',

        'alert_error'         => 'Veuillez vérifier les champs et réessayer.',
        'status_success'      => 'Merci ! Votre message a bien été envoyé. Nous vous répondrons dès que possible.',
